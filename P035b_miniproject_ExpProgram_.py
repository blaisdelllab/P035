...
class MainScreen(object):
    ...
    def __init__(self, subject_ID, record_data, data_folder_directory,
        ...
        if self.exp_phase_num == 0: # For familiarization phase
            ...
            #   .....
            # }
            # Create a list of comparisons and shuffle it
            ...
            # Ensure each block of 10 trials has balanced left/right locations
                ...
                # Round-robin assignment of comparisons to trials
                for i in range(num_comparisons):
                    if trial_counter > self.max_trials:
                        break
                    comparison = comparison_list[i]  # Round-robin assignment
                    location = location_list.pop()  # Get the location from the balanced list
